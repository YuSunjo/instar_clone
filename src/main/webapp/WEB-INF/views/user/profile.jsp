		...
		<div class="profile-right">
			<div class="name-group">
				...
				<c:choose>
					...
					<c:otherwise>
						<button class="cta" onclick="toggleSubscribe(${dto.user.id})">구독하기</button>
					</c:otherwise>
					<c:choose>
						<c:when test="${dto.subscribeState}">
							<button class="cta blue" onclick="toggleSubscribe(${dto.user.id})">구독취소</button>
						</c:when>
						<c:otherwise>
	...
	<div class="profileContainer">
		...
		<div id="tab-1-content" class="tab-content-item show">
			...
			<div class="tab-1-content-inner">
				...
				<c:forEach var = "image" items="${user.images}">     <!--   EL 표현식에서 변수명을 적으면 get함수가 자동 호출 -->
					<div class="img-box">
